  ...
  return (
    <div className="mt-24">
      <div className="flex flex-wrap lg:flex-nowrap justify-center ">
        ...
        <div className="flex m-3 flex-wrap justify-center gap-1 items-center lg:m-2">
          {earningData.map((item)=>(
            <div key={item.title} className='bg-white dark:text:gray-200 dark:bg-secondary-dark-bg md:w-9rem p-4 pt-9 rounded-2xl'>
